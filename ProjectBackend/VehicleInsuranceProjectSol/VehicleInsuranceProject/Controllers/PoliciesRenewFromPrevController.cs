...
namespace VehicleInsuranceProject.Controllers
{
    ...
    public class PoliciesRenewFromPrevController : ApiController
    {
        ...
        // PUT: api/PoliciesRenewFromPrev/5
        ...
        // POST: api/PoliciesRenewFromPrev
        [ResponseType(typeof(tbl_Policies))]
        ...
        // DELETE: api/PoliciesRenewFromPrev/5
        [ResponseType(typeof(tbl_Policies))]
